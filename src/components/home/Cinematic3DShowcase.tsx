    ...
    <section className="overflow-hidden bg-stone-950 py-16 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-xs uppercase tracking-wide text-brand-400">{t.showcase3d.hint}</p>
        </div>
      </div>
      ...
      <div className="mx-auto mt-4 max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <a
          href="#gallery-full"
          className="inline-block text-sm font-semibold text-brand-400 underline underline-offset-4 hover:text-brand-300"
        >
